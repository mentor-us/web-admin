    ...
    try {
      const result = await model.generateContent(
        `i have a list of users=${JSON.stringify(
          channelMembers
        )} and i want to extract the meeting and assign them tasks in this html ${content} - match user by name and insert user's id to assignees or attendees list. Please help me summarize the tasks and meeting to JSON and find match users id in the list. Return only the json data without code block. Divide the task and meeting by type task or meeting whick key "tasks" for tasks and "meetings" for meetings.`
      );
